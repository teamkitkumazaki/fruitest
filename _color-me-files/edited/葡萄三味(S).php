  ...
  <div class="inner">
    ...
    <div class="info_wrap">
      <div class="info_item block">
        ...
        <span class="content">ピオーネ：ぶどう（ピオーネ）<br>シャインマスカット：ぶどう（シャインマスカット）<br>巨峰：ぶどう（巨峰）</span>
      </div>
      <div class="info_item block">
        <span class="title">産地</span>
        <span class="content">ピオーネ：山梨県韮崎市<br> シャインマスカット：山梨県笛吹市<br>巨峰：山梨県山梨市（牧岡地区）</span>
      </div>
      <div class="info_item block">
